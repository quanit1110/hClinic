...
namespace DanhMuc
{
    public partial class mnc1DMDoiTuongGiaLoaiGiaUC : DevExpress.XtraEditors.XtraUserControl
    {
        public mnc1DMDoiTuongGiaLoaiGiaUC()
        {
            InitializeComponent();
            ...
            tvDoiTuong.ImageList = imageList1;
            ThuVien.DanhMuc.TreeVDoiTuong(tvDoiTuong);
        }
