...
namespace DanhMuc
{
    public partial class mnc1DanhMucPhongBanGiuongBenhUC : DevExpress.XtraEditors.XtraUserControl
    {
        public mnc1DanhMucPhongBanGiuongBenhUC()
        {
            InitializeComponent();
            ...
            ThuVien.Danhmuc.PhongBanGiuongBenh.TVPhongBan(tvPhongBan);
            loadGV();
        }
        ...
        private void loadGV()
        {
            ThuVien.Danhmuc.PhongBanGiuongBenh.LoadNhanVien(gridControl1);
            GridColumn colReceived = gridView1.Columns["TenPhongBan"];
            GridColumn col = gridView1.Columns["Expr1"];
            gridView1.BeginSort();
            try
            {
