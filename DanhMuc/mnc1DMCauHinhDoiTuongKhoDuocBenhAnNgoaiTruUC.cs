...
namespace DanhMuc
{
    public partial class mnc1DMCauHinhDoiTuongKhoDuocBenhAnNgoaiTruUC : DevExpress.XtraEditors.XtraUserControl
    {
        public mnc1DMCauHinhDoiTuongKhoDuocBenhAnNgoaiTruUC()
        {
            InitializeComponent();
            ...
            ThuVien.DanhMuc.DoiTuong(gridControl1);
            ThuVien.DanhMuc.GVKHoDuoc(gridControl2);
        }
