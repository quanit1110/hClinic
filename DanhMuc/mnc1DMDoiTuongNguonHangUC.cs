...
namespace DanhMuc
{
    public partial class mnc1DMDoiTuongNguonHangUC : DevExpress.XtraEditors.XtraUserControl
    {
        public mnc1DMDoiTuongNguonHangUC()
        {
            InitializeComponent();
            ...
            ThuVien.DanhMuc.TreeVDoiTuong(treeView1);
            ThuVien.DanhMuc.TVNguonHang(treeView2);
        }
