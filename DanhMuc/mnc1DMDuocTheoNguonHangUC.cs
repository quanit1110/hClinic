...
namespace DanhMuc
{
    public partial class mnc1DMDuocTheoNguonHangUC : DevExpress.XtraEditors.XtraUserControl
    {
        public mnc1DMDuocTheoNguonHangUC()
        {
            InitializeComponent();
        ...
        {
            string ma = lkNguonHang.EditValue.ToString();
            ThuVien.DanhMuc.GVDuoc_NguonHang(gridControl1, "NguonDuoc_Id = " + ma + "");
        }
    }
}
