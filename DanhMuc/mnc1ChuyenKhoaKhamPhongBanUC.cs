...
namespace DanhMuc
{
    public partial class mnc1ChuyenKhoaKhamPhongBanUC : DevExpress.XtraEditors.XtraUserControl
    {
        public mnc1ChuyenKhoaKhamPhongBanUC()
        {
            InitializeComponent();
            ...
            tvChuyenKHoa.ImageList = imageList1;
            tvPhongKham.ImageList = imageList1;
            ThuVien.DanhMuc.TVChuyenKhoa(tvChuyenKHoa);
        ...
        private void tvChuyenKHoa_NodeMouseClick(object sender, TreeNodeMouseClickEventArgs e)
        {
            
            ThuVien.DanhMuc.TVPhongKham(tvPhongKham);
            tvChuyenKHoa.ImageIndex = 1;
        }
    }
}
