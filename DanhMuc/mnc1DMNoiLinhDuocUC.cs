...
namespace DanhMuc
{
    public partial class mnc1DMNoiLinhDuocUC : DevExpress.XtraEditors.XtraUserControl
    {
        public mnc1DMNoiLinhDuocUC()
        {
            InitializeComponent();
            ...
            ThuVien.DanhMuc.TreeVKho(tvKho);
            ThuVien.DanhMuc.GVNoiLinhDuoc(gridControl1);
        }
