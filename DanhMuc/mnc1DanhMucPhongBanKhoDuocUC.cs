...
namespace DanhMuc
{
    public partial class mnc1DanhMucPhongBanKhoDuocUC : DevExpress.XtraEditors.XtraUserControl
    {
        public mnc1DanhMucPhongBanKhoDuocUC()
        {
            InitializeComponent();
            ...
            tvKhoDuoc.ImageList = imageList1;
            ThuVien.DanhMuc.loadTVPB(tvPhongBan);
            ThuVien.DanhMuc.TreeVKho(tvKhoDuoc);
        }
