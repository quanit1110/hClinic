...
namespace DanhMuc
{
    public partial class mncHeThongDanhMucUC : DevExpress.XtraEditors.XtraUserControl
    {
        public mncHeThongDanhMucUC()
        {
            InitializeComponent();
        ...
        private void tviewDinhNghiaDanhMuc_NodeMouseClick(object sender, TreeNodeMouseClickEventArgs e)
        {
            ...
            string node = e.Node.Tag.ToString();
            txtTenNode.Text = e.Node.Text.ToString();
            //ThuVien.clsHeThongDanhMuc.Laytablename(grControl, "Table_Name", "[mHIS_Hethong].[dbo].[DinhNghiaDanhMuc]", "Dictionary_Type_Id", node);
        }
    }
}
