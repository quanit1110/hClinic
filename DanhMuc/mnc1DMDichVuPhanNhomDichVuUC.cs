...
namespace DanhMuc
{
    public partial class mnc1DMDichVuPhanNhomDichVuUC : DevExpress.XtraEditors.XtraUserControl
    {
        public mnc1DMDichVuPhanNhomDichVuUC()
        {
            InitializeComponent();
            ...
            ThuVien.Danhmuc.PhanNhomDichVu.loadTV(tvDichVu);
        }
