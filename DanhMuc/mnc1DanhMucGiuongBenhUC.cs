...
namespace DanhMuc
{
    public partial class mnc1DanhMucGiuongBenhUC : DevExpress.XtraEditors.XtraUserControl
    {
        public mnc1DanhMucGiuongBenhUC()
        {
            InitializeComponent();
        ...
        private void loadGV()
        {
            ThuVien.Danhmuc.DMGiuongBenh.GiuongBenh(gridControl1);
