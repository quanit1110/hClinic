...
namespace DanhMuc
{
    public partial class mnc1DMQuanLyKhoNhapTuNCCUC : DevExpress.XtraEditors.XtraUserControl
    {
        public mnc1DMQuanLyKhoNhapTuNCCUC()
        {
            InitializeComponent();
        ...
        private void tvKhoDuoc_NodeMouseClick(object sender, TreeNodeMouseClickEventArgs e)
        {
            string ma = e.Node.Tag.ToString();
            gridControl1.DataSource = null;
            gridView1.Columns.Clear();
            ThuVien.DanhMuc.LoadGVKhoDuoc(gridControl1);
        }
