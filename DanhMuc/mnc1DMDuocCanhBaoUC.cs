...
namespace DanhMuc
{
    public partial class mnc1DMDuocCanhBaoUC : DevExpress.XtraEditors.XtraUserControl
    {
        public mnc1DMDuocCanhBaoUC()
        {
            InitializeComponent();
            ...
            Common.clsControl.LoadLookUp(lkPhamVi, "PhamViDanhMucDuoc");
        }
