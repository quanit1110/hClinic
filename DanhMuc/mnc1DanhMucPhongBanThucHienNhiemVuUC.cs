...
namespace DanhMuc
{
    public partial class mnc1DanhMucPhongBanThucHienNhiemVuUC : DevExpress.XtraEditors.XtraUserControl
    {
        public mnc1DanhMucPhongBanThucHienNhiemVuUC()
        {
            InitializeComponent();
            ...
            ThuVien.Danhmuc.PhongBanThucHienNhiemVu.TVPhongBan(tvPhongBan);
            loadGV();
        }
        ...
        private void loadGV()
        {
            ThuVien.Danhmuc.PhongBanThucHienNhiemVu.GVDichVu(gridControl1);
