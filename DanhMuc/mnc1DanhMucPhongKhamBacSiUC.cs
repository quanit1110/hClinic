...
namespace DanhMuc
{
    public partial class mnc1DanhMucPhongKhamBacSiUC : DevExpress.XtraEditors.XtraUserControl
    {
        public mnc1DanhMucPhongKhamBacSiUC()
        {
            InitializeComponent();
            ...
            ThuVien.Danhmuc.DMPhongBan_BacSi.TVPhongBan(tvPhongBan);
            loadGV();
        }
        ...
        private void loadGV()
        {
            ThuVien.Danhmuc.DMPhongBan_BacSi.LoadNhanVien(gridControl1);
