...
namespace BaoCao.Report {
    ...
    public class BCVP_065_DuyetToaThuoc : ReportClass {
        
        public BCVP_065_DuyetToaThuoc() {
        }
        
        public override string ResourceName {
            get {
                return "BCVP_065_DuyetToaThuoc.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "BaoCao.Report.BCVP_065_DuyetToaThuoc.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedBCVP_065_DuyetToaThuoc : Component, ICachedReport {
        
        public CachedBCVP_065_DuyetToaThuoc() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            BCVP_065_DuyetToaThuoc rpt = new BCVP_065_DuyetToaThuoc();
            rpt.Site = this.Site;
            return rpt;
        }
