...
{
    public partial class mncKetQuaMauDienCoUC : DevExpress.XtraEditors.XtraUserControl
    {
        public mncKetQuaMauDienCoUC()
        {
            InitializeComponent();
        ...
        private void LoadLookUp()
        {
            ...
            Common.clsControl.LoadLK(lkKyThuatVien2, "KyThuatVien");
