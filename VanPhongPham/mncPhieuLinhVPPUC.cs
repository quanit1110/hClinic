...
{
    public partial class mncPhieuLinhVPPUC : DevExpress.XtraEditors.XtraUserControl
    {
        public mncPhieuLinhVPPUC()
        {
            InitializeComponent();
        ...
        {
            ThuVien.FcLoadLookup nhapkho = new ThuVien.FcLoadLookup("VPP_ChungTu", "ChungTu_Id", "MaChungTu", "SoChungTu", "where LoaiChungTu = 'X' ");
            nhapkho.ShowDialog();
